...
const sendVerificationEmail = async ({ _id, email }, res) => {
  try {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: "CAKE MANE : verify email",
      html: `<p>Please verify your email to complete the registration process of CAKE MANE.
             Click <a href="${
...
userRouter.post("/register", async (req, res) => {
  ...
  user = new User({
    ...
    contact: contact,
    password: spassword,
    // here it is temporary solution ----here it is 
    // verified: false,
    verified: false,
    image: image,
    status: false,
